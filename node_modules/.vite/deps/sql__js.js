  ...
  "node_modules/sql.js/dist/sql-wasm.js"(exports, module) {
    ...
    var initSqlJs = function(moduleConfig) {
      ...
      initSqlJsPromise = new Promise(function(resolveModule, reject) {
            ...
            try {
              ...
              for (g = []; 0 !== l(G, "i8"); ) {
                ...
                if (0 !== I) {
                  y = null;
                  v = new c(I, this);
                  for (null != m && v.bind(m); v.step(); ) null === y && (y = { columns: v.getColumnNames(), values: [] }, g.push(y)), y.values.push(v.get(null, n));
                  v.free();
                }
              }
              return g;
        ...
        if (Aa) D = za ? require_path().dirname(D) + "/" : __dirname + "/", Fa = () => {
        ...
        var mb = { open: function(a) {
          ...
          if (a.Ma != b) if (0 == b) a.Ia = null, a.Ma = 0;
          else {
            var c = a.Ia;
          ...
          a = a.node.Ia;
          if (f & 2 || a.buffer !== Na) {
            if (0 < c || c + b < a.length) a.subarray ? a = a.subarray(c, c + b) : a = Array.prototype.slice.call(
              a,
              c,
              c + b
            );
          ...
          for (var c = Ab, d = "/", f = 0; f < a.length; f++) {
            ...
            if (!h || b.Sa) {
              for (h = 0; 40960 === (c.mode & 61440); ) if (c = Eb(d), d = hb(eb(d), c), c = U(d, { kb: b.kb + 1 }).node, 40 < h++) throw new P(32);
            }
          }
        ...
        function ua(a, b) {
          ...
          try {
            ...
            if ("function" == typeof WebAssembly.Function) {
              ...
              for (var h = { parameters: [], results: "v" == b[0] ? [] : [f[b[0]]] }, k = 1; k < b.length; ++k) h.parameters.push(f[b[k]]);
              b = new d(h, a);
            } else {
              d = [1, 96];
              f = b.slice(0, 1);
